...
public class Controller {
	...
	{
		//Uso el campo codigo de cliente de la vista obtenido en la b�squeda previa	
		Videoclub.getInstance().buscaPendientesRetrasosTablaPestaniaSocio(tarjeta);

	}

	/**
	 * �apa para meter a pelo el codigo de la pel�cula en v2.4
	 * @param clave
	 */
	...
	/**
	 * Puede dar problemas si la pel�cula se llama 300 pero bueno...
	 * @param clave
	 */
	...
	/**
	 * Actualiza lo que hayan tocado de la pel�cula
	 * @param cod
	 * @param tit
	 * @param pases
	 * @param PVP
	...
	/**
	 * Devolver la pel�cula dado al "espacio", no confundir con busca3SociosPelicula
	 * @param codPel
	 */
	...
	/**
	 * M�todo para el listado de socios
	 * @return
	 */
	...
	/**
	 * M�todo para el listados de pel�culas
	 * @return
	 */
...
//		System.out.println("	E L A P S E D getAlquileres-> " + (double)diff_time / 1000000000.0);
	...
	/**
	 * Cuando cierra la aplicaci�n guarda el fichero con 
	 * el n�mero de alquileres que llevamos
	 */
